...
int exitDelay = 5000;           //duration of light flash interval after python program exits
...
int beamBreakThreshold = 2;    //number of consecutive beam breaks needed to trigger response 
                                ///total duration = (beamBreakLimit * ledDelay)
unsigned long interTrialInterval = 30000;  //milliseconds til next trial begins

void setup() {
  // initialize I/Os for arduino
