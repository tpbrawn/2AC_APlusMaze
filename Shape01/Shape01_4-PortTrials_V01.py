...
maxTrialsNorth = 5              #maximum number of trials to run at North port
maxTrialsEast = 5               #maximum number of trials to run at East port
maxTrialsSouth = 5              #maximum number of trials to run at South port
maxTrialsWest = 5               #maximum number of trials to run at West port
...
trainingProtocol = "Shape01_4-PortTrials"
