...
#       -Shape02_1PortTrials_North_V02.ino
#       -Shape02_1PortTrials_East_V02.ino
#       -Shape02_1PortTrials_South_V02.ino
#       -Shape02_1PortTrials_West_V02.ino
...
############################################################################
################   define function: SendPortLocationSignal   ###################
############################################################################
def SendPortLocationSignal(portLocation):
...
maxTrialNum = 10                                #maximum number of trials to run
...
trainingProtocol = "Shape02_1PortTrials"
...
##################################################################
    if portLocation == 'N':
        while True:
            SendPortLocationSignal(portLocation)
